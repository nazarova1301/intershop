# Тестирование интернет-магазина Intershop :shopping_cart:

1. Я протестировала интернет-магазин Intershop, предназначенный для успешного продвижения и продажи товаров заказчика, и подготовила различные виды документации по тестированию:
   * [Тест-кейсы 1](https://docs.google.com/spreadsheets/d/1DJSNBnWn7Uzzjb3NqeUNtytigNOK0HwhnF5XAEEp-oE/edit?usp=drive_link) – исследовательское тестирование форм авторизации и регистрации.
   * [Тестирование требований](https://docs.google.com/document/d/1tP1hsc1bQMjQaAszIWbMPRvQDALb2UbJpM6VaeLzL2A/edit?usp=drive_link) – список вопросов и уточнений к требованиям в техспецификации.
   ...
   * [Тест-кейсы 5](https://docs.google.com/spreadsheets/d/1rXoPKu2e-2GlNT-GfdVJ2BwhkKEHF523R8Q7d9mTpgo/edit?usp=drive_link) – UI-тестирование редизайна всего сайта в соответствии с макетами в Figma.
...
2. Я протестировала все методы в Postman, которые предусмотрены для интернет-магазина Intershop, и создала соответствующие коллекции:
   * [REST API](https://www.postman.com/zvozdochka12-8536216/rest-api/collection/v9sjoar/intershop?action=share&creator=48999753) – коллекция Postman для интернет-магазина Intershop.
   * [Тест-кейсы 1](https://docs.google.com/spreadsheets/d/1Qt8oftZzPC4C5G-MuWRe5csfBkTdEL6sTw6wtRT8_bY/edit?usp=drive_link) – негативное тестирование метода POST.
